...
একটি বহুল পরিচিত উদাহরণ দিয়ে শুরু করা যাকঃ

```python
{% include "../tutorial/tuto1.py" %}
```

[উপরের কোড দিয়ে তৈরিক্রীত পিডিএফ](https://github.com/PyFPDF/fpdf2/raw/master/tutorial/tuto1.pdf)

লাইব্রেরি ফাইলটি যোগ করার পর আমরা  `FPDF` অবজেক্টি তৈরি করি. The 
[FPDF](fpdf/fpdf.html#fpdf.fpdf.FPDF) কন্সট্রাক্টরটি শুরুতে পেজ এর সাইজ A4, পেইজ এর অরিয়েন্টেশন portrait এবং দূরত্ব পরিমাপের একক মিলিমিটার ধরে নেয়।
আমরা চাইলে নিম্নক্ত কোড দারা এই বৈশিষ্ট্য গুলো নিজেদের মত করে সেট করতে পারিঃ
